...
//https://docs.google.com/spreadsheets/d/1OS6vvVKksK6UptapP20_P6Q1TAPOk4QR6p2eslv9XKE/edit?usp=sharing

function cargarOfertas () {
   //busca en el backend todas las ofertas
   $("#plantilla").hide();
         console.log("aca hay data");
   $.getJSON(('https://sheets.googleapis.com/v4/spreadsheets/1OS6vvVKksK6UptapP20_P6Q1TAPOk4QR6p2eslv9XKE/values/2?alt=json&key=AIzaSyBPapQfp9clNlpDy-_y3Gqy-LomxzZcPWE'), function (data) {
